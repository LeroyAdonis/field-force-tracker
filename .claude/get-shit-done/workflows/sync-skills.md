...
INSTALL_JS_GLOBAL="/home/hermesuser/field-force-tracker/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/hermesuser/field-force-tracker/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
