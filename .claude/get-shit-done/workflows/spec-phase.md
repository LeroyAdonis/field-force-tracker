...
```bash
INIT=$(node "/home/hermesuser/field-force-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/hermesuser/field-force-tracker/.claude/get-shit-done/templates/spec.md.
