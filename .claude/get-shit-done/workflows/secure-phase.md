...
```
Task(
  prompt="Read /home/hermesuser/field-force-tracker/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/hermesuser/field-force-tracker/.claude/get-shit-done/templates/SECURITY.md`
